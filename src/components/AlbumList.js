...
function AlbumList() {
// const albumList =  albums.map((album) => <AlbumCard name={album.name} image={album.image} genre={album.genre} /> )  
  return (
    <section className="albums">
      {albums.map((album) => <AlbumCard name={album.name} image={album.image} genre={album.genre} /> )}
